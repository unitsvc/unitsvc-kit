package com.unitsvc.kit.poi4.excel.read.service;
 ...
 **/
public class UniV4Excel2007ReadService {

    /**
     * 工作表处理器
     */
    private final UniV4XSSFSheetXMLHandler.SheetContentsHandler sheetContentsHandler;
     ...
     */
    public UniV4Excel2007ReadService(UniV4XSSFSheetXMLHandler.SheetContentsHandler sheetContentsHandler) {
     ...
     * @throws Exception
     */
    private void parse(OPCPackage pkg, UniV4XSSFSheetXMLHandler.SheetContentsHandler sheetContentsHandler, String importSheetName) throws Exception {
        // 1.创建XSSFReader对象
        ...
        while (sheets.hasNext()) {
            try (InputStream sheetStream = sheets.next()) {
                ...
                xmlReader.setContentHandler(
                        new UniV4XSSFSheetXMLHandler(sheetIndex++, sheetName, styles, sheetComments, sst, sheetContentsHandler, new DataFormatter(), false)
                );
     ...
     * @throws Exception
     */
    private void parse(OPCPackage pkg, UniV4XSSFSheetXMLHandler.SheetContentsHandler sheetContentsHandler, Integer importSheetIndex) throws Exception {
        // 1.创建XSSFReader对象
        XSSFReader reader = new XSSFReader(pkg);
        // 2.获取SharedStringsTable对象
        SharedStrings sst = reader.getSharedStringsTable();
