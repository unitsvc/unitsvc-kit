 ...
 * <p>
 * See {@link org.apache.poi.xssf.eventusermodel.XSSFSheetXMLHandler.SheetContentsHandler} for the interface that
 * you need to implement for reading information from a file.
 */
@SuppressWarnings("all")
public class UniV4XSSFSheetXMLHandler extends DefaultHandler {

    private static final POILogger logger = POILogFactory.getLogger(UniV4XSSFSheetXMLHandler.class);
     ...
     * 公式字符串
     */
    private String customeExtFormula;
    /**
     * 单元格原始值
     */
     ...
     */
    public UniV4XSSFSheetXMLHandler(
            Integer sheetIndex,
            String sheetName,
            Styles styles,
            Comments comments,
        ...
        if (isTextTag(localName)) {
            ...
            switch (nextDataType) {
                ...
                case FORMULA:
                    // -------------------------------------------
                    // 保存单元格公式
                    customeExtFormula = formula.toString();
                    // -------------------------------------------
                    if (formulasNotResults) {
            ...
            // Output
            output.cell(cellRef, thisStr, comment, rowNum, customExtColIndex, customExtColTitle, nextDataType, customExtStyle, customExtOriginValue, customeExtFormula, customExtSheetIndex, customExtSheetName);
        } else if ("f".equals(localName)) {
            fIsOpen = false;
        } else if ("is".equals(localName)) {
            isIsOpen = false;
    ...
    private void outputEmptyCellComment(CellAddress cellRef) {
        ...
        output.cell(cellRef.formatAsString(), null, comment, rowNum, customExtColIndex, customExtColTitle, nextDataType, customExtStyle, customExtOriginValue, customeExtFormula, customExtSheetIndex, customExtSheetName);
    }
     ...
     * <p>
     * The XSLX file is usually read via {@link org.apache.poi.xssf.eventusermodel.XSSFReader}.
     * <p>
