...
public abstract class UniV5SheetDefaultHandler extends UniAbstractSheetHandler implements UniV5XSSFSheetXMLHandler.SheetContentsHandler {
    ...
    @Override
    public void cell(String cellReference, String formattedValue, XSSFComment comment, Integer customExtRowIndex, Integer customExtColIndex, String customExtColTitle, UniV5XSSFSheetXMLHandler.xssfDataType customExtXssfDataType, XSSFCellStyle customExtStyle, String customExtOriginValue, String customExtFormula, Integer customExtSheetIndex, String customExtSheetName) {
        // 不读取批注内容
        if (null != comment) {
            // 去除批注逻辑
            return;
